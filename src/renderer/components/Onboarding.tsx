...
export function Onboarding(): JSX.Element | null {
  ...
  return (
    <div className="absolute inset-0 z-[70] flex items-center justify-center bg-shell">
      <section className="w-[760px] rounded-md border border-line bg-panel p-6 shadow-2xl">
        ...
        <div className="mt-5 grid grid-cols-2 gap-2">
          ...
          >
            ...
            <div className="mt-1 text-xs text-muted">Paste an export and let AppDeck build it.</div>
          </button>
          <button
