...
export function Toolbar(): JSX.Element {
  ...
  return (
    <header className="flex h-12 shrink-0 items-center gap-2 border-b border-line bg-shell px-3">
      <button className="icon-button" aria-label="Add service" title="Add service" onClick={() => setCatalogOpen(true)}>
        <Plus size={17} />
      </button>
      <button
      ...
      <button
        ...
        aria-label="Single view" aria-pressed={layoutMode === 'single'} title="Single view"
      ...
      <button
        ...
        aria-label="Split view" aria-pressed={layoutMode === 'split'} title="Split view"
      ...
      <button
        ...
        aria-label="Grid view" aria-pressed={layoutMode === 'grid'} title="Grid view"
      ...
      <button
        ...
        aria-label="Do Not Disturb" aria-pressed={dnd} title={dnd ? 'Do Not Disturb on' : 'Do Not Disturb off'}
        onClick={() => void toggleDnd()}
      >
        {dnd ? <BellOff size={16} /> : <Bell size={16} />}
      </button>
      <button className="icon-button" aria-label="Dashboard home" title="Dashboard home" onClick={() => setDashboardOpen(true)}>
        <LayoutDashboard size={16} />
      </button>
      <button className="icon-button relative" aria-label="Inbox" title="Inbox" onClick={() => setInboxOpen(true)}>
        <Inbox size={16} />
      ...
      <button className="icon-button" aria-label="Command palette" title="Command palette" onClick={() => setCommandOpen(true)}>
        <Search size={16} />
      </button>
      <button className="icon-button" aria-label="Tasks" title="Tasks" onClick={() => setTaskPanelOpen(true)}>
        <PanelRight size={16} />
      </button>
      <button
        className="icon-button"
      ...
      <button className="icon-button" aria-label="Lock" title="Lock" onClick={() => void lock()}>
        <Lock size={16} />
      </button>
    </header>
  );
